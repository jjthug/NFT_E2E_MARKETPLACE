...
import "./ProducerTokenUriValidator.sol";

abstract contract ERC1155Base is OwnableUpgradeable, ERC1155DefaultApproval, ERC1155BurnableUpgradeable, ERC1155Lazy, HasContractURI, ProducerTokenUriValidator {
    string public name;
