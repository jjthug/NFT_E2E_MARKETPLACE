...
abstract contract ERC1155Lazy is IERC1155LazyMint, ERC1155BaseURI, Mint1155Validator, RoyaltiesV2Upgradeable, RoyaltiesV2Impl {
    ...
    function _setMovieRevealTime(string memory _movieId, uint256 time) internal {
        nftRevealTime[_movieId] = time;
    }

    function _setMovieProducer(string memory _movieId, address producer) internal {
        movieProducer[_movieId] = producer;
    }
